...
{
    public function direct($resource, $params = array(), $mode = FinalView_Application_Resource::ACCESS_MODE_SOFT)
    {
       return $this->isAllowed($resource, $params, $mode);
    }

    public function isAllowed($resource, $params = array(), $mode = FinalView_Application_Resource::ACCESS_MODE_SOFT)
    {
